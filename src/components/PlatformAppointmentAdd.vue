        ...
        <div class="form-warpper">
          <el-form :model="appointmentInfo" label-width="100px" class="demo-ruleForm">
            <el-form-item label="选择站点">
              <el-select v-model="station" filterable remote placeholder="请搜索: 站点 / 联系人" :remote-method="searchStation" :loading="loading">
...
<script>
  ...
  export default {
    ...
    watch: {
      station () {
        this.appointmentInfo.customerId = this.station.id
        this.appointmentInfo.customerName = this.station.customerName
      }
    },
    methods: {
      back () {
